...
def split_data_wrapper(spectra_location,
                       data_directory,
                       ionization_mode):
    spectra = list(load_pickled_file(spectra_location))
    random.seed(42)
    validation_spectra, test_spectra, train_spectra = split_spectra_in_random_inchikey_sets(spectra, 20)
    ...
    save_pickled_file(validation_spectra, os.path.join(data_directory, "training_and_validation_split",
                                                       f"{ionization_mode}_validation_spectra.pickle"))
    save_pickled_file(test_spectra, os.path.join(data_directory, "training_and_validation_split",
                                                 f"{ionization_mode}_test_spectra.pickle"))
    save_pickled_file(train_spectra, os.path.join(data_directory, "training_and_validation_split",
