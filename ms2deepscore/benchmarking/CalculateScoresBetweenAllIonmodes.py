...
from ms2deepscore.validation_loss_calculation.calculate_scores_for_validation import (
    ...
    create_embedding_matrix_not_symmetric,
...
class CalculateScoresBetweenAllIonmodes:
    ...
    def get_tanimoto_and_prediction_pairs(
        ...
        tanimoto_scores_df = calculate_tanimoto_scores_unique_inchikey(
            spectra_1, spectra_2, fingerprint_type=fingerprint_type, nbits=n_bits
        )
