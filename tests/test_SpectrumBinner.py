...
from ms2deepscore.MetadataFeatureGenerator import PrecursorMZFeatureGenerator, IonizationModeFeatureGenerator
...
def test_spectrum_binner_additional_metadata():
    ...
    spectrum_1 = Spectrum(mz=np.array([10, 20, 50, 100.]),
                          intensities=np.array([0.7, 0.6, 0.2, 0.1]),
                          metadata={'inchikey': "test_inchikey_01", "parent_mass": "100", "precursor_mz": "99", "ionization_mode": "positive"})
