...
binned_training_spectra_file_name = os.path.join(data_directory, "binned_spectra", "binned_training_spectra" + file_label + ".pickle")
binned_validation_spectra_file_name = os.path.join(data_directory, "binned_spectra", "binned_validation_spectra" + file_label + ".pickle")
